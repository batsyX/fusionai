...
const Page = () => {
  return (
    <div className="md:pt-20">
      <h1 className='font-bauhaus fonr-bold text-4xl  text-center'>Unleash the power of
      ...
      <div className='flex flex-col items-center w-full px-10 pt-10 gap-10'>
            ...
            <div className="flex flex-col gap-2 py-20 px-10 rounded-xl shadow-2xl  shadow-slate-400 mb-10 ring-1 ring-slate-100  ">
            {
                links.map((link,index)=>{
                    return(
                        <Link href={link.href} className={`flex items-center gap-2 w-80  px-4 py-3 rounded-xl  shadow-md duration-200 hover:bg-slate-200 cursor-pointer`} key={index}>
